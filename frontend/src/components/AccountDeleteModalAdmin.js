...
const AccountDeleteModalAdmin = ({ cancel, confirm }) => {
      ...
      <div className="mx-4 sm:mx-0 max-w-md bg-white p-8 rounded-lg">
        <div>
          <p className="leading-relaxed font-bold">
            You are going to Delete your user&rsquo;s Account!
          </p>
          <p className="font-bold mb-6 text-red-500 leading-relaxed">
            Are you sure?
          </p>
          <p className="italic leading-relaxed text-sm">
            Note that you will close user&rsquo;s{' '}
            <span className="font-bold">OpSoftware</span> account!. And his
            premium subscriptions will also be canceled immidately.
          </p>
...
export default AccountDeleteModalAdmin;
